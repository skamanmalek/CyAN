...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Miccosukee</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 4.840030606,
    'AVFST_Max': 83.93,
    'ARAIN_Average': 166.71,
    'HUC12_forest_and_shrubland_4': 52.12472983,
    'HUC10_grassland_and_pasture_3': 6.814294869,
    'HUC10_cropland_area_1': 4.090401762,
    'HUC12_developed_area_5': 4.502196193
}

coefficients = {
    'intercept': -0.103655878,
    'AVFST_Max': 0.024411134,
    'ARAIN_Average': -0.013146455,
    'HUC12_forest_and_shrubland_4': 0.190542679,
    'HUC10_grassland_and_pasture_3': -0.010055415,
    'HUC10_cropland_area_1': 0.044368275,
    'HUC12_developed_area_5': -0.01357574
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Miccosukee.")
