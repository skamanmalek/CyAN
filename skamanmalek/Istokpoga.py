...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Istokpoga</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 88.4402036,
    'AVFST_Max': 85.694,
    'ARAIN_Average': 181.54,
    'HUC12_forest_and_shrubland_4': 4.720329418,
    'HUC10_grassland_and_pasture_3': 21.95034812,
    'HUC10_cropland_area_1': 16.25679087,
    'HUC12_developed_area_5': 8.831246795
}

coefficients = {
    'intercept': 2.895541854,
    'AVFST_Max': -0.047028672,
    'ARAIN_Average': -0.218311193,
    'HUC12_forest_and_shrubland_4': -1.995516858,
    'HUC10_grassland_and_pasture_3': -2.137006588,
    'HUC10_cropland_area_1': -8.602964032,
    'HUC12_developed_area_5': -0.451533866
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Istokpoga.")
