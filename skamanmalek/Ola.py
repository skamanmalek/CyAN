...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Ola</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 42.05111873,
    'AVFST_Max': 86.09,
...
coefficients = {
    'intercept': 0.300562489,
    'AVFST_Max': -0.024645125,
    'ARAIN_Average': 0.046311826,
    'HUC12_forest_and_shrubland_4': 0.02480468,
    'HUC10_grassland_and_pasture_3': 0.283615791,
    'HUC10_cropland_area_1': 0.470482137,
    'HUC12_developed_area_5': -0.347558192
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Ola.")
