...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Huntley</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': -0.184864966,
    'AVFST_Max': 85.694,
    'ARAIN_Average': 181.54,
    'HUC12_forest_and_shrubland_4': 3.097706032,
    'HUC10_grassland_and_pasture_3': 7.618479909,
    'HUC10_cropland_area_1': 22.79390733,
    'HUC12_developed_area_5': 28.12914189
}

coefficients = {
    'intercept': -0.029200608,
    'AVFST_Max': 0.082780551,
    'ARAIN_Average': 0.048676141,
    'HUC12_forest_and_shrubland_4': 0.574917456,
    'HUC10_grassland_and_pasture_3': -0.036342987,
    'HUC10_cropland_area_1': -0.218935056,
    'HUC12_developed_area_5': 0.051683103
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Huntley.")
