...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Dead Lakes</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 2.389621162,
    'AVFST_Max': 85.46,
    'ARAIN_Average': 168.31,
    'HUC12_forest_and_shrubland_4': 45.26512789,
    'HUC10_grassland_and_pasture_3': 4.813542737,
    'HUC10_cropland_area_1': 4.928501032,
    'HUC12_developed_area_5': 6.529707176
}

coefficients = {
    'intercept': 0.009772226,
    'AVFST_Max': 0.002304242,
    'ARAIN_Average': -0.010602171,
    'HUC12_forest_and_shrubland_4': -0.013341929,
    'HUC10_grassland_and_pasture_3': -0.016101308,
    'HUC10_cropland_area_1': 0.011962629,
    'HUC12_developed_area_5': 0.12542578
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Dead Lakes.")
