...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Jesup</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 148.3840388,
    'AVFST_Max': 85.712,
    'ARAIN_Average': 186.51,
    'HUC12_forest_and_shrubland_4': 5.518442158,
    'HUC10_grassland_and_pasture_3': 5.683321508,
    'HUC10_cropland_area_1': 0.381572188,
    'HUC12_developed_area_5': 39.96408626
}

coefficients = {
    'intercept': -3.103366288,
    'AVFST_Max': 0.220099251,
    'ARAIN_Average': 0.619603823,
    'HUC12_forest_and_shrubland_4': 3.957100447,
    'HUC10_grassland_and_pasture_3': 5.358132492,
    'HUC10_cropland_area_1': -0.531574635,
    'HUC12_developed_area_5': 5.759091551
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Jesup.")
