...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Rochelle</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 28.76671872,
    'AVFST_Max': 87.602,
...
coefficients = {
    'intercept': 0.846072494,
    'AVFST_Max': 0.084663963,
    'ARAIN_Average': -0.049829144,
    'HUC12_forest_and_shrubland_4': -2.88192489,
    'HUC10_grassland_and_pasture_3': 0.060217987,
    'HUC10_cropland_area_1': -0.014755281,
    'HUC12_developed_area_5': -1.547536446
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Rochelle.")
