...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Orange</h1>"
...
initial_values = {
    ...
    'AVFST_Max': 88.196,
    'ARAIN_Average': 171,
    'HUC12_forest_and_shrubland_4': 48.79342213,
    'HUC10_grassland_and_pasture_3': 12.77713616,
    'HUC10_cropland_area_1': 1.287959577,
    'HUC12_developed_area_5': 4.198572103
}

coefficients = {
    'intercept': -0.604482163,
    'AVFST_Max': -0.054909321,
    'ARAIN_Average': -0.270358033,
    'HUC12_forest_and_shrubland_4': 1.733210372,
    'HUC10_grassland_and_pasture_3': 1.746317696,
    'HUC10_cropland_area_1': -2.13892072,
    'HUC12_developed_area_5': -9.681707671
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Orange.")
