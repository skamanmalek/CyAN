...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Winterset</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 41.00226093,
    'AVFST_Max': 87.404,
    'ARAIN_Average': 180.29,
    'HUC12_forest_and_shrubland_4': 1.037321863,
    'HUC10_grassland_and_pasture_3': 19.8966616,
    'HUC10_cropland_area_1': 19.16765117,
    'HUC12_developed_area_5': 51.9214894
}

coefficients = {
    'intercept': -1.286656452,
    'AVFST_Max': 0.436065064,
    'ARAIN_Average': 0.371289364,
    'HUC12_forest_and_shrubland_4': -1.121138944,
    'HUC10_grassland_and_pasture_3': -0.376405596,
    'HUC10_cropland_area_1': 0.552989139,
    'HUC12_developed_area_5': 1.704525658
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Winterset.")
