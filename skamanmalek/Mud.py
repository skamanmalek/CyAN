...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Mud</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 58.09863734,
    'AVFST_Max': 86.216,
    'ARAIN_Average': 175.95,
    'HUC12_forest_and_shrubland_4': 70.61328519,
    'HUC10_grassland_and_pasture_3': 6.526100307,
    'HUC10_cropland_area_1': 0.084019403,
    'HUC12_developed_area_5': 7.808633781
}

coefficients = {
    'intercept': -3.056399651,
    'AVFST_Max': 0.509656419,
    'ARAIN_Average': -0.065781063,
    'HUC12_forest_and_shrubland_4': 3.115933644,
    'HUC10_grassland_and_pasture_3': 0.109931398,
    'HUC10_cropland_area_1': 0.487528976,
    'HUC12_developed_area_5': 3.90557747
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Mud.")
