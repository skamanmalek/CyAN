...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Conway</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 4.266615184,
    'AVFST_Max': 85.892,
    'ARAIN_Average': 183.13,
    'HUC12_forest_and_shrubland_4': 1.119858544,
    'HUC10_grassland_and_pasture_3': 6.753999684,
    'HUC10_cropland_area_1': 0.555522157,
    'HUC12_developed_area_5': 77.66513704
}

coefficients = {
    'intercept': 0.060571998,
    'AVFST_Max': -0.038136714,
    'ARAIN_Average': -0.008749688,
    'HUC12_forest_and_shrubland_4': -0.002061253,
    'HUC10_grassland_and_pasture_3': -0.430656968,
    'HUC10_cropland_area_1': -0.139258516,
    'HUC12_developed_area_5': 0.017941186
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Conway.")
