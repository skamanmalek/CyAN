...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Howard</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 141.6066776,
    'AVFST_Max': 87.602,
...
coefficients = {
    'intercept': -1.018641172,
    'AVFST_Max': 0.201074283,
    'ARAIN_Average': -0.047570967,
    'HUC12_forest_and_shrubland_4': 0.737266884,
    'HUC10_grassland_and_pasture_3': -0.757919088,
    'HUC10_cropland_area_1': -0.925240731,
    'HUC12_developed_area_5': 3.08174024
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Howard.")
