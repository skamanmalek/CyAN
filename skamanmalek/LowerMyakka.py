...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Lowe rMyakka</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 15.96821883,
    'AVFST_Max': 85.118,
    'ARAIN_Average': 181.04,
    'HUC12_forest_and_shrubland_4': 8.776003932,
    'HUC10_grassland_and_pasture_3': 21.8514134,
    'HUC10_cropland_area_1': 1.295247292,
    'HUC12_developed_area_5': 4.665414402
}

coefficients = {
    'intercept': 0.069862485,
    'AVFST_Max': -0.067043342,
    'ARAIN_Average': 0.019997581,
    'HUC12_forest_and_shrubland_4': 0.302195066,
    'HUC10_grassland_and_pasture_3': -0.429992393,
    'HUC10_cropland_area_1': -0.182672837,
    'HUC12_developed_area_5': 1.981703409
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Lower Myakka.")
