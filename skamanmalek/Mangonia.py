...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Mangonia</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 6.336758909,
    'AVFST_Max': 85.748,
    'ARAIN_Average': 204.88,
    'HUC12_forest_and_shrubland_4': 0.154017791,
    'HUC10_grassland_and_pasture_3': 0.595244844,
    'HUC10_cropland_area_1': 0.079649429,
    'HUC12_developed_area_5': 78.76331612
}

coefficients = {
    'intercept': -0.17100139,
    'AVFST_Max': 0.098814021,
    'ARAIN_Average': 0.1386249,
    'HUC12_forest_and_shrubland_4': 16.73568884,
    'HUC10_grassland_and_pasture_3': 0.032688264,
    'HUC10_cropland_area_1': 0.037473658,
    'HUC12_developed_area_5': 0.03512583
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Mangonia.")
