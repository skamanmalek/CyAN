...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in West Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 116.1903152,
    'AVFST_Max': 88.484,
...
coefficients = {
    'intercept': 0.973155988,
    'AVFST_Max': -0.343527882,
    'ARAIN_Average': -0.021703764,
    'HUC12_forest_and_shrubland_4': -368.3266643,
    'HUC10_grassland_and_pasture_3': 317.9439542,
    'HUC10_cropland_area_1': -0.377572877,
    'HUC12_developed_area_5': -200.9381282
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for West Lake.")
