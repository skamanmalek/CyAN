...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Mattie</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 80.78013638,
    'AVFST_Max': 85.676,
...
coefficients = {
    'intercept': 0.596881995,
    'AVFST_Max': 0.310157959,
    'ARAIN_Average': -0.780321492,
    'HUC12_forest_and_shrubland_4': -2.723171185,
    'HUC10_grassland_and_pasture_3': -1.589297045,
    'HUC10_cropland_area_1': -0.812052714,
    'HUC12_developed_area_5': 5.423654309
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Mattie.")
