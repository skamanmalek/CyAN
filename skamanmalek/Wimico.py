...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Wimico</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 3.701728665,
    'AVFST_Max': 87.008,
    'ARAIN_Average': 183.49,
    'HUC12_forest_and_shrubland_4': 4.372572066,
    'HUC10_grassland_and_pasture_3': 0.178785422,
    'HUC10_cropland_area_1': 0.050389387,
    'HUC12_developed_area_5': 4.591832425
}

coefficients = {
    'intercept': -0.006221553,
    'AVFST_Max': 0.012000792,
    'ARAIN_Average': 0.004527706,
    'HUC12_forest_and_shrubland_4': -0.013706725,
    'HUC10_grassland_and_pasture_3': -0.006081665,
    'HUC10_cropland_area_1': 0.004426531,
    'HUC12_developed_area_5': 0.311113802
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Wimico.")
