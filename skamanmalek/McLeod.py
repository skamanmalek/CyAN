...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake McLeod</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 6.556896337,
    'AVFST_Max': 87.476,
...
coefficients = {
    'intercept': 0.426417361,
    'AVFST_Max': -0.227459594,
    'ARAIN_Average': -0.039984882,
    'HUC12_forest_and_shrubland_4': 1.113777031,
    'HUC10_grassland_and_pasture_3': -0.282523828,
    'HUC10_cropland_area_1': -1.472743298,
    'HUC12_developed_area_5': 0.211070991
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake McLeod.")
