...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Panasoffkee</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 35.78789516,
    'AVFST_Max': 86.468,
    'ARAIN_Average': 176.63,
    'HUC12_forest_and_shrubland_4': 5.250386794,
    'HUC10_grassland_and_pasture_3': 28.98865856,
    'HUC10_cropland_area_1': 5.754883139,
    'HUC12_developed_area_5': 11.40904487
}

coefficients = {
    'intercept': 0.329585061,
    'AVFST_Max': 0.053774384,
    'ARAIN_Average': -0.235929765,
    'HUC12_forest_and_shrubland_4': -0.477730083,
    'HUC10_grassland_and_pasture_3': -0.111002103,
    'HUC10_cropland_area_1': -0.191184851,
    'HUC12_developed_area_5': -0.265830183
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Panasoffkee.")
