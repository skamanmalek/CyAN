...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Placid</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 58.57931309,
    'AVFST_Max': 86.702,
    'ARAIN_Average': 181.24,
...
coefficients = {
    'intercept': -0.437123263,
    'AVFST_Max': 0.035234182,
    'ARAIN_Average': 0.31696922,
    'HUC12_forest_and_shrubland_4': 4.888218104,
    'HUC10_grassland_and_pasture_3': -0.604558552,
    'HUC10_cropland_area_1': -2.81501137,
    'HUC12_developed_area_5': 2.967415372
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Placid.")
