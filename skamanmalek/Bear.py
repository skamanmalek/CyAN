...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Bearr</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 41.72190021,
    'AVFST_Max': 84.992,
...
coefficients = {
    'intercept': 0.427350149,
    'AVFST_Max': -0.458796109,
    'ARAIN_Average': 0.339069904,
    'HUC12_forest_and_shrubland_4': -74.95689988,
    'HUC10_grassland_and_pasture_3': 157.8382576,
    'HUC10_cropland_area_1': 0.007023866,
    'HUC12_developed_area_5': -433.8666549
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Bear.")
