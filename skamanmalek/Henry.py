...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Henry</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 41.42934238,
    'AVFST_Max': 87.602,
...
coefficients = {
    'intercept': -1.394202213,
    'AVFST_Max': 0.100075515,
    'ARAIN_Average': -0.129203355,
    'HUC12_forest_and_shrubland_4': 0.444222951,
    'HUC10_grassland_and_pasture_3': -0.030647366,
    'HUC10_cropland_area_1': 0.572259518,
    'HUC12_developed_area_5': 3.190928109
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Henry.")
