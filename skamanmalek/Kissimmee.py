...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Kissimmee</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 90.88568961,
    'AVFST_Max': 85.604,
    'ARAIN_Average': 181.12,
    'HUC12_forest_and_shrubland_4': 13.17251079,
    'HUC10_grassland_and_pasture_3': 31.13518528,
    'HUC10_cropland_area_1': 1.966365587,
    'HUC12_developed_area_5': 0.980856931
}

coefficients = {
    'intercept': 1.4987486,
    'AVFST_Max': -0.378525639,
    'ARAIN_Average': -0.044747426,
    'HUC12_forest_and_shrubland_4': -1.208921766,
    'HUC10_grassland_and_pasture_3': -0.512646533,
    'HUC10_cropland_area_1': -0.502915829,
    'HUC12_developed_area_5': -39.20869008
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Kissimmee.")
