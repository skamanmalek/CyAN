...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Blue Cypress Lakee</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 5.04727505,
    'AVFST_Max': 84.488,
    'ARAIN_Average': 183.14,
    'HUC12_forest_and_shrubland_4': 0.083796755,
    'HUC10_grassland_and_pasture_3': 21.93433127,
    'HUC10_cropland_area_1': 11.76724393,
    'HUC12_developed_area_5': 0.307254768
}

coefficients = {
    'intercept': -0.079151363,
    'AVFST_Max': -0.013220715,
    'ARAIN_Average': 0.137410848,
    'HUC12_forest_and_shrubland_4': -0.159636136,
    'HUC10_grassland_and_pasture_3': 0.013998484,
    'HUC10_cropland_area_1': -0.018320096,
    'HUC12_developed_area_5': 19.72120858
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Blue Cypress Lake.")
