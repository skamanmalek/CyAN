...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Blue Cypress</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Initial values according to the baseline of 2022 for Lake Apopka
initial_values = {
    'Norm_CyAN': 6.430954598,
    'AVFST_Max': 84.488,
    'ARAIN_Average': 183.14,
    'HUC12_TN': 16.88992718,
    'HUC10_TP': 17.20127263,
...
coefficients = {
    'intercept': 0.369731382,
    'AVFST_Max': 0.01237551,
    'ARAIN_Average': 0.080125828,
    'HUC12_TN': 0.656111386,
    'HUC10_TP': -0.657770895,
    'HUC10_cropland_area_1': 0.006377055,
    'HUC12_developed_area_5': -0.373960124
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Blue Cypress.")
