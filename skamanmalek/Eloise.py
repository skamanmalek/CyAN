...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Eloise</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 57.2174633,
    'AVFST_Max': 87.404,
...
coefficients = {
    'intercept': -2.107759939,
    'AVFST_Max': 0.676026767,
    'ARAIN_Average': 0.539612687,
    'HUC12_forest_and_shrubland_4': -1.891342393,
    'HUC10_grassland_and_pasture_3': -0.615947732,
    'HUC10_cropland_area_1': 0.982738243,
    'HUC12_developed_area_5': 2.753313368
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Eloise.")
