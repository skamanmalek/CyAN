...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Dias</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 16.27009228,
    'AVFST_Max': 86.27,
    'ARAIN_Average': 177.74,
    'HUC12_forest_and_shrubland_4': 32.04399054,
    'HUC10_grassland_and_pasture_3': 9.354178826,
    'HUC10_cropland_area_1': 1.784445048,
    'HUC12_developed_area_5': 17.20326766
}

coefficients = {
    'intercept': -0.312185121,
    'AVFST_Max': -0.080613768,
    'ARAIN_Average': 0.272899987,
    'HUC12_forest_and_shrubland_4': 0.51059402,
    'HUC10_grassland_and_pasture_3': -0.546566501,
    'HUC10_cropland_area_1': 0.323494272,
    'HUC12_developed_area_5': 1.03453009
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Dias.")
