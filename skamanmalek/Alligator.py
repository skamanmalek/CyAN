...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Alligator</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 3.55583022,
    'AVFST_Max': 85.874,
...
coefficients = {
    'intercept': 0.176212059,
    'AVFST_Max': -0.001014322,
    'ARAIN_Average': -0.024502707,
    'HUC12_forest_and_shrubland_4': -0.171507316,
    'HUC10_grassland_and_pasture_3': 0.221557337,
    'HUC10_cropland_area_1': 0.157600508,
    'HUC12_developed_area_5': -0.956195392
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Alligator.")
