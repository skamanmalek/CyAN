...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Yale</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 61.35153103,
    'AVFST_Max': 86.18,
    'ARAIN_Average': 178.73,
    'HUC12_forest_and_shrubland_4': 10.50795135,
    'HUC10_grassland_and_pasture_3': 15.72252642,
    'HUC10_cropland_area_1': 3.553565082,
    'HUC12_developed_area_5': 14.07871996
}

coefficients = {
    'intercept': 2.017868083,
    'AVFST_Max': -0.186767283,
    'ARAIN_Average': -0.722016449,
    'HUC12_forest_and_shrubland_4': -3.614946106,
    'HUC10_grassland_and_pasture_3': -4.955643883,
    'HUC10_cropland_area_1': 2.618860191,
    'HUC12_developed_area_5': -0.628672327
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Yale.")
