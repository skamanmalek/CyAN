...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Parrish</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 20.96387518,
    'AVFST_Max': 87.296,
    'ARAIN_Average': 179.29,
    'HUC12_forest_and_shrubland_4': 2.350636005,
    'HUC10_grassland_and_pasture_3': 39.87434685,
    'HUC10_cropland_area_1': 6.460722397,
    'HUC12_developed_area_5': 19.24369902
}

coefficients = {
    'intercept': 0.301250933,
    'AVFST_Max': -0.043422194,
    'ARAIN_Average': -0.10813114,
    'HUC12_forest_and_shrubland_4': -0.076897668,
    'HUC10_grassland_and_pasture_3': -0.504761946,
    'HUC10_cropland_area_1': -0.617996068,
    'HUC12_developed_area_5': 0.645735806
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Parrish.")
