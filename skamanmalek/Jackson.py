...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Jackson</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 4.392142169,
    'AVFST_Max': 85.964,
...
coefficients = {
    'intercept': 0.089553014,
    'AVFST_Max': -0.012329663,
    'ARAIN_Average': -0.02908086,
    'HUC12_forest_and_shrubland_4': -0.05097146,
    'HUC10_grassland_and_pasture_3': 0.208418479,
    'HUC10_cropland_area_1': -0.089988405,
    'HUC12_developed_area_5': -0.101186142
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Jackson.")
