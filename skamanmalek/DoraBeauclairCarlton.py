...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake DoraBeauclairCarlton</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Initial values according to the baseline of 2022 for Lake Apopka
initial_values = {
    'Norm_CyAN': 69.7398272,
    'AVFST_Max': 86.09,
    'ARAIN_Average': 179.15,
    'HUC12_TN': 143.3295971,
    'HUC10_TP': 15.25889389,
...
coefficients = {
    'intercept': 0.162020375,
    'AVFST_Max': -0.133922525,
    'ARAIN_Average': -0.232600613,
    'HUC12_TN': -1.038999273,
    'HUC10_TP': 1.612021034,
    'HUC10_cropland_area_1': 0.262218744,
    'HUC12_developed_area_5': 0.312195521
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake DoraBeauclairCarlton.")
