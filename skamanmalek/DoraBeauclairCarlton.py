...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Dora/Beauclair/Carlton</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 83.16035646,
    'AVFST_Max': 86.09,
    'ARAIN_Average': 179.15,
    'HUC12_forest_and_shrubland_4': 8.397530176,
    'HUC10_grassland_and_pasture_3': 12.92275406,
    'HUC10_cropland_area_1': 3.332721843,
    'HUC12_developed_area_5': 34.31124184
}

coefficients = {
    'intercept': 0.618410243,
    'AVFST_Max': -0.043732103,
    'ARAIN_Average': 0.109499924,
    'HUC12_forest_and_shrubland_4': 0.065951822,
    'HUC10_grassland_and_pasture_3': 0.602032703,
    'HUC10_cropland_area_1': 0.979725504,
    'HUC12_developed_area_5': -0.782501427
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Dora/Beauclair/Carlton.")
