...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Juliana</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 113.8705419,
    'AVFST_Max': 85.676,
    'ARAIN_Average': 180.31,
    'HUC12_forest_and_shrubland_4': 2.544949941,
    'HUC10_grassland_and_pasture_3': 22.90891304,
    'HUC10_cropland_area_1': 7.427740848,
    'HUC12_developed_area_5': 7.510719145
}

coefficients = {
    'intercept': 0.291453492,
    'AVFST_Max': 0.816108941,
    'ARAIN_Average': -0.778347777,
    'HUC12_forest_and_shrubland_4': -6.231779069,
    'HUC10_grassland_and_pasture_3': 0.828421875,
    'HUC10_cropland_area_1': 0.487510783,
    'HUC12_developed_area_5': 1.021781918
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Juliana.")
