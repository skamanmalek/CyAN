...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Deaton</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': -3.686062296,
    'AVFST_Max': 86.558,
    'ARAIN_Average': 178.61,
    'HUC12_forest_and_shrubland_4': 10.02891493,
    'HUC10_grassland_and_pasture_3': 28.98865856,
    'HUC10_cropland_area_1': 5.754883139,
    'HUC12_developed_area_5': 37.72447116
}

coefficients = {
    'intercept': 0.427657833,
    'AVFST_Max': -0.236341684,
    'ARAIN_Average': 0.030984848,
    'HUC12_forest_and_shrubland_4': -0.817507918,
    'HUC10_grassland_and_pasture_3': -0.140985659,
    'HUC10_cropland_area_1': -0.145061219,
    'HUC12_developed_area_5': -0.36096203
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Deaton.")
