...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Minnehahs Susan</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Initial values according to the baseline of 2022 for Lake Apopka
initial_values = {
    'Norm_CyAN': 3.462860899,
    'AVFST_Max': 86.09,
    'ARAIN_Average': 182.28,
    'HUC12_TN': 166.051492,
    'HUC10_TP': 18.63067843,
    'HUC10_cropland_area_1': 7.781039427,
    'HUC12_developed_area_5': 27.28130076
}

# Coefficients for Lake Apopka
coefficients = {
    'intercept': 0.061492684,
    'AVFST_Max': 0.007074471,
    'ARAIN_Average': 0.040849102,
    'HUC12_TN': -0.29547238,
    'HUC10_TP': 0.103894824,
    'HUC10_cropland_area_1': -0.004253385,
    'HUC12_developed_area_5': 0.181289317
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake  Minnehahs Susan.")
