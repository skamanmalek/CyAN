...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Gentry</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 2.407268824,
    'AVFST_Max': 85.874,
    'ARAIN_Average': 181.96,
    'HUC12_forest_and_shrubland_4': 7.566623843,
    'HUC10_grassland_and_pasture_3': 32.28017088,
    'HUC10_cropland_area_1': 4.111972914,
    'HUC12_developed_area_5': 7.393681853
}

coefficients = {
    'intercept': 0.087081619,
    'AVFST_Max': -0.032763624,
    'ARAIN_Average': 0.038065807,
    'HUC12_forest_and_shrubland_4': -0.04744877,
    'HUC10_grassland_and_pasture_3': -0.14926928,
    'HUC10_cropland_area_1': -0.158232001,
    'HUC12_developed_area_5': -0.008793371
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Gentry.")
