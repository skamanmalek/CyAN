...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Lizzie</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 6.497939984,
    'AVFST_Max': 85.874,
...
coefficients = {
    'intercept': 0.174382753,
    'AVFST_Max': 0.01224842,
    'ARAIN_Average': 0.001687213,
    'HUC12_forest_and_shrubland_4': -0.328442094,
    'HUC10_grassland_and_pasture_3': 0.559967945,
    'HUC10_cropland_area_1': 0.380209755,
    'HUC12_developed_area_5': -1.497812518
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Lizzie.")
