...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Rodgers River Bay</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 0.476044634,
    'AVFST_Max': 89.15,
    'ARAIN_Average': 201.7,
    'HUC12_forest_and_shrubland_4': 0.010033764,
    'HUC10_grassland_and_pasture_3': 0.010269256,
    'HUC10_cropland_area_1': 0.003674304,
    'HUC12_developed_area_5': 0.084745886
}

coefficients = {
    'intercept': -0.011083231,
    'AVFST_Max': 0.009805878,
    'ARAIN_Average': 0.013839564,
    'HUC12_forest_and_shrubland_4': 28.42336746,
    'HUC10_grassland_and_pasture_3': -36.11925692,
    'HUC10_cropland_area_1': -0.00094174,
    'HUC12_developed_area_5': -5.189464019
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Rodgers River Bay.")
