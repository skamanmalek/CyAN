...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Swan Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 4.23056015,
    'AVFST_Max': 85.172,
...
coefficients = {
    'intercept': 0.114939026,
    'AVFST_Max': -0.004318377,
    'ARAIN_Average': -0.10958781,
    'HUC12_forest_and_shrubland_4': -0.075187357,
    'HUC10_grassland_and_pasture_3': -0.099041711,
    'HUC10_cropland_area_1': 0.128956142,
    'HUC12_developed_area_5': -0.069111993
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Swan Lake.")
