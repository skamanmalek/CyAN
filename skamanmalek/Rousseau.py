...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Rousseau</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 4.757571041,
    'AVFST_Max': 85.982,
    'ARAIN_Average': 169.84,
    'HUC12_forest_and_shrubland_4': 39.11613953,
    'HUC10_grassland_and_pasture_3': 24.54186514,
    'HUC10_cropland_area_1': 4.317253762,
    'HUC12_developed_area_5': 18.36017045
}

coefficients = {
    'intercept': 0.234445371,
    'AVFST_Max': 0.016698214,
    'ARAIN_Average': -0.029929655,
    'HUC12_forest_and_shrubland_4': -0.184860771,
    'HUC10_grassland_and_pasture_3': -0.094738988,
    'HUC10_cropland_area_1': -0.163635658,
    'HUC12_developed_area_5': -0.379906319
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Rousseau.")
