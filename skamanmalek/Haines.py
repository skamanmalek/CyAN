...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Haines</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 41.43438498,
    'AVFST_Max': 87.602,
...
coefficients = {
    'intercept': -0.132881481,
    'AVFST_Max': 0.117428711,
    'ARAIN_Average': -0.090523293,
    'HUC12_forest_and_shrubland_4': -2.43352343,
    'HUC10_grassland_and_pasture_3': -0.319694467,
    'HUC10_cropland_area_1': 0.778591103,
    'HUC12_developed_area_5': 0.52610683
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Haines.")
