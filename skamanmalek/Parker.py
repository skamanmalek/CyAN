...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Parker</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 149.9265144,
    'AVFST_Max': 86.522,
    'ARAIN_Average': 181.39,
    'HUC12_forest_and_shrubland_4': 1.70084337,
    'HUC10_grassland_and_pasture_3': 11.92659881,
    'HUC10_cropland_area_1': 4.35476106,
    'HUC12_developed_area_5': 44.32516289
}

coefficients = {
    'intercept': -2.730164068,
    'AVFST_Max': -0.132014123,
    'ARAIN_Average': 0.226188784,
    'HUC12_forest_and_shrubland_4': 0.938973344,
    'HUC10_grassland_and_pasture_3': -2.858668377,
    'HUC10_cropland_area_1': -1.097119374,
    'HUC12_developed_area_5': 7.089785743
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Parker.")
