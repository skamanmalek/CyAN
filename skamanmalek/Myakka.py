...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Myakka</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 14.66712628,
    'AVFST_Max': 85.46,
    'ARAIN_Average': 181.98,
    'HUC12_forest_and_shrubland_4': 5.126423714,
    'HUC10_grassland_and_pasture_3': 36.01050642,
    'HUC10_cropland_area_1': 2.370591261,
    'HUC12_developed_area_5': 8.184959067
}

coefficients = {
    'intercept': 0.058673159,
    'AVFST_Max': -0.07100696,
    'ARAIN_Average': 0.034545505,
    'HUC12_forest_and_shrubland_4': 0.322535286,
    'HUC10_grassland_and_pasture_3': -0.39988425,
    'HUC10_cropland_area_1': -0.172257714,
    'HUC12_developed_area_5': 1.902090043
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Myakka.")
