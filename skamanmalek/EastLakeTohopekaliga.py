...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in East Lake Tohopekaliga</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 3.351558786,
    'AVFST_Max': 85.946,
    'ARAIN_Average': 182.75,
    'HUC12_forest_and_shrubland_4': 2.234701557,
    'HUC10_grassland_and_pasture_3': 6.753999684,
    'HUC10_cropland_area_1': 0.555522157,
    'HUC12_developed_area_5': 37.30098998
}

coefficients = {
    'intercept': -0.127616338,
    'AVFST_Max': -0.01217556,
    'ARAIN_Average': 0.024228878,
    'HUC12_forest_and_shrubland_4': 0.072550523,
    'HUC10_grassland_and_pasture_3': 0.217347637,
    'HUC10_cropland_area_1': 0.060489956,
    'HUC12_developed_area_5': 0.260133659
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for East Lake Tohopekaliga.")
