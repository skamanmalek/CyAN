...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Arbuckle</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 29.42487951,
    'AVFST_Max': 85.55,
    'ARAIN_Average': 178.52,
    'HUC12_forest_and_shrubland_4': 30.95577154,
    'HUC10_grassland_and_pasture_3': 7.860022176,
    'HUC10_cropland_area_1': 22.48329033,
    'HUC12_developed_area_5': 4.184352058
}

coefficients = {
    'intercept': 0.552486278,
    'AVFST_Max': -0.258352488,
    'ARAIN_Average': -0.006951156,
    'HUC12_forest_and_shrubland_4': -0.503136819,
    'HUC10_grassland_and_pasture_3': -0.731409481,
    'HUC10_cropland_area_1': -0.50164459,
    'HUC12_developed_area_5': 1.881975219
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Arbuckle.")
