...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Winder</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 8.316145908,
    'AVFST_Max': 86.09,
    'ARAIN_Average': 212.67,
    'HUC12_forest_and_shrubland_4': 1.058090542,
    'HUC10_grassland_and_pasture_3': 32.71662666,
    'HUC10_cropland_area_1': 0.223292897,
    'HUC12_developed_area_5': 17.69361636
}

coefficients = {
    'intercept': -0.015893139,
    'AVFST_Max': -0.110293441,
    'ARAIN_Average': 0.215613845,
    'HUC12_forest_and_shrubland_4': 0.017667124,
    'HUC10_grassland_and_pasture_3': -0.226728315,
    'HUC10_cropland_area_1': -0.217765695,
    'HUC12_developed_area_5': 0.113675518
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Winder.")
