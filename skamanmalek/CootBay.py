...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Coot Bay Pond</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 31.18180422,
    'AVFST_Max': 84.992,
    'ARAIN_Average': 192.58,
...
coefficients = {
    'intercept': 0.417598986,
    'AVFST_Max': -0.808458824,
    'ARAIN_Average': 0.428284994,
    'HUC12_forest_and_shrubland_4': 1.136360262,
    'HUC10_grassland_and_pasture_3': 90.20707527,
    'HUC10_cropland_area_1': 0.108511625,
    'HUC12_developed_area_5': -380.591762
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Coot Bay Pond.")
