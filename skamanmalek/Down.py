...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Down</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 2.041213728,
    'AVFST_Max': 86.522,
    'ARAIN_Average': 183.8,
...
coefficients = {
    'intercept': 0.077502035,
    'AVFST_Max': 0.000177553,
    'ARAIN_Average': -0.035075666,
    'HUC12_forest_and_shrubland_4': -0.191528652,
    'HUC10_grassland_and_pasture_3': -0.224257364,
    'HUC10_cropland_area_1': -0.068108908,
    'HUC12_developed_area_5': -0.037569757
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Down.")
