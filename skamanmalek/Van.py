...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Van</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 26.76545543,
    'AVFST_Max': 85.874,
    'ARAIN_Average': 179.71,
...
coefficients = {
    'intercept': 0.348252576,
    'AVFST_Max': -0.051555515,
    'ARAIN_Average': -0.081894561,
    'HUC12_forest_and_shrubland_4': -0.290655895,
    'HUC10_grassland_and_pasture_3': -0.814321693,
    'HUC10_cropland_area_1': -0.54072503,
    'HUC12_developed_area_5': 1.261184141
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Van.")
