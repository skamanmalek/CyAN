...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in J T Budd Pond</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 5.820001302,
    'AVFST_Max': 84.83,
    'ARAIN_Average': 165.17,
    'HUC12_forest_and_shrubland_4': 50.38838709,
    'HUC10_grassland_and_pasture_3': 3.789388501,
    'HUC10_cropland_area_1': 1.985003063,
    'HUC12_developed_area_5': 5.685657489
}

coefficients = {
    'intercept': -0.206431427,
    'AVFST_Max': 0.005446159,
    'ARAIN_Average': 0.152530236,
    'HUC12_forest_and_shrubland_4': 0.156649926,
    'HUC10_grassland_and_pasture_3': -0.168434566,
    'HUC10_cropland_area_1': 0.12917445,
    'HUC12_developed_area_5': 1.939266576
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for J T Budd Pond.")
