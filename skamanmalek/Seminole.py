...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Seminole</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 1.615001002,
    'AVFST_Max': 85.478,
    'ARAIN_Average': 163.72,
    'HUC12_forest_and_shrubland_4': 34.62948963,
    'HUC10_grassland_and_pasture_3': 2.446293118,
    'HUC10_cropland_area_1': 28.39817106,
    'HUC12_developed_area_5': 4.232599903
}

coefficients = {
    'intercept': 0.029988377,
    'AVFST_Max': -0.01750935,
    'ARAIN_Average': 0.022367334,
    'HUC12_forest_and_shrubland_4': -0.095278324,
    'HUC10_grassland_and_pasture_3': 0.002724904,
    'HUC10_cropland_area_1': 0.014959292,
    'HUC12_developed_area_5': 0.402620581
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Seminole.")
