...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Reedy</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 106.3379151,
    'AVFST_Max': 85.55,
...
coefficients = {
    'intercept': 0.679628256,
    'AVFST_Max': -1.168639662,
    'ARAIN_Average': -0.709424353,
    'HUC12_forest_and_shrubland_4': 5.355538983,
    'HUC10_grassland_and_pasture_3': -5.63134866,
    'HUC10_cropland_area_1': 1.26373978,
    'HUC12_developed_area_5': 1.742593031
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Reedy.")
