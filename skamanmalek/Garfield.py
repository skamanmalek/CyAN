...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Garfield</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 15.34235103,
    'AVFST_Max': 87.404,
    'ARAIN_Average': 180.29,
    'HUC12_forest_and_shrubland_4': 1.705031793,
    'HUC10_grassland_and_pasture_3': 19.8966616,
    'HUC10_cropland_area_1': 19.16765117,
    'HUC12_developed_area_5': 17.43396919
}

coefficients = {
    'intercept': 0.419777855,
    'AVFST_Max': -0.290280803,
    'ARAIN_Average': 0.096169864,
    'HUC12_forest_and_shrubland_4': 0.504682312,
    'HUC10_grassland_and_pasture_3': 0.299636162,
    'HUC10_cropland_area_1': -1.112226548,
    'HUC12_developed_area_5': -0.131918056
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Garfield.")
