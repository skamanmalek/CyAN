...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Eustis</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 144.9163277,
    'AVFST_Max': 86.09,
    'ARAIN_Average': 179.15,
    'HUC12_forest_and_shrubland_4': 4.129594132,
    'HUC10_grassland_and_pasture_3': 15.72252642,
    'HUC10_cropland_area_1': 3.553565082,
    'HUC12_developed_area_5': 31.78468937
}

coefficients = {
    'intercept': -0.78619543,
    'AVFST_Max': -0.621098605,
    'ARAIN_Average': -0.55984828,
    'HUC12_forest_and_shrubland_4': 5.564184579,
    'HUC10_grassland_and_pasture_3': 3.832979908,
    'HUC10_cropland_area_1': -3.219056288,
    'HUC12_developed_area_5': 2.668155725
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Eustis.")
