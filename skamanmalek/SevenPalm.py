...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Seven Palm Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 80.31904844,
    'AVFST_Max': 88.394,
    'ARAIN_Average': 193.52,
    'HUC12_forest_and_shrubland_4': 0.012547439,
    'HUC10_grassland_and_pasture_3': 0.01353284,
    'HUC10_cropland_area_1': 0.005124085,
    'HUC12_developed_area_5': 0.095780973
}

coefficients = {
    'intercept': 0.634515294,
    'AVFST_Max': 0.486561969,
    'ARAIN_Average': -0.379568525,
    'HUC12_forest_and_shrubland_4': 532.2487484,
    'HUC10_grassland_and_pasture_3': -612.5427188,
    'HUC10_cropland_area_1': -0.172281751,
    'HUC12_developed_area_5': -669.0978007
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Seven Palm Lake.")
