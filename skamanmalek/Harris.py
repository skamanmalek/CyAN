...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Harris</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 124.1798359,
    'AVFST_Max': 88.07,
    'ARAIN_Average': 178.12,
    'HUC12_forest_and_shrubland_4': 6.719741613,
    'HUC10_grassland_and_pasture_3': 21.73461119,
    'HUC10_cropland_area_1': 7.180775865,
    'HUC12_developed_area_5': 17.37768376
}

coefficients = {
    'intercept': -2.030152884,
    'AVFST_Max': -0.022256632,
    'ARAIN_Average': -0.358114532,
    'HUC12_forest_and_shrubland_4': 1.884250908,
    'HUC10_grassland_and_pasture_3': 4.316430105,
    'HUC10_cropland_area_1': 2.756818665,
    'HUC12_developed_area_5': 5.643225457
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Harris.")
