...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Konomac</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Initial values according to the baseline of 2022 for Lake Apopka
initial_values = {
    'Norm_CyAN': 11.99802883,
    'AVFST_Max': 85.946,
    'ARAIN_Average': 184.77,
    'HUC12_TN': 126.9676077,
...
coefficients = {
    'intercept': 0.051346444,
    'AVFST_Max': -0.019455286,
    'ARAIN_Average': 0.376698904,
    'HUC12_TN': -0.768770258,
    'HUC10_TP': 0.23249992,
    'HUC10_cropland_area_1': -0.132535612,
    'HUC12_developed_area_5': 0.168910259
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Konomac Apopka.")
