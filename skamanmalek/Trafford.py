...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Trafford</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 137.3060402,
    'AVFST_Max': 85.856,
    'ARAIN_Average': 174.97,
    'HUC12_forest_and_shrubland_4': 0.430933772,
    'HUC10_grassland_and_pasture_3': 11.08272409,
    'HUC10_cropland_area_1': 17.47627775,
    'HUC12_developed_area_5': 7.855415288
}

coefficients = {
    'intercept': -3.184946083,
    'AVFST_Max': 0.191081086,
    'ARAIN_Average': 0.276572726,
    'HUC12_forest_and_shrubland_4': 1.004317073,
    'HUC10_grassland_and_pasture_3': 0.394837381,
    'HUC10_cropland_area_1': 0.255983803,
    'HUC12_developed_area_5': 37.07456182
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Trafford.")
