...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Josephine</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 8.931587512,
    'AVFST_Max': 85.964,
    'ARAIN_Average': 184.62,
    'HUC12_forest_and_shrubland_4': 3.370769635,
    'HUC10_grassland_and_pasture_3': 7.618479909,
    'HUC10_cropland_area_1': 22.79390733,
    'HUC12_developed_area_5': 35.36566127
}

coefficients = {
    'intercept': 0.51357247,
    'AVFST_Max': 0.096619691,
    'ARAIN_Average': 0.28068275,
    'HUC12_forest_and_shrubland_4': 0.023945634,
    'HUC10_grassland_and_pasture_3': 0.802559306,
    'HUC10_cropland_area_1': -1.452497576,
    'HUC12_developed_area_5': -0.679712134
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Josephine.")
