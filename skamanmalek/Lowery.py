...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Lowery</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 1.948873444,
    'AVFST_Max': 85.172,
    'ARAIN_Average': 180.52,
    'HUC12_forest_and_shrubland_4': 3.645762547,
    'HUC10_grassland_and_pasture_3': 21.97415169,
    'HUC10_cropland_area_1': 7.781039427,
    'HUC12_developed_area_5': 15.11358121
}

coefficients = {
    'intercept': -0.110371162,
    'AVFST_Max': 0.030011283,
    'ARAIN_Average': 0.057050305,
    'HUC12_forest_and_shrubland_4': 0.385598531,
    'HUC10_grassland_and_pasture_3': 0.056164521,
    'HUC10_cropland_area_1': 0.101547465,
    'HUC12_developed_area_5': 0.274129161
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Lowery.")
