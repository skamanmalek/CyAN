...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Weohyakapka</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 44.84252804,
    'AVFST_Max': 85.55,
    'ARAIN_Average': 176.3,
    'HUC12_forest_and_shrubland_4': 20.67475164,
    'HUC10_grassland_and_pasture_3': 13.29057294,
    'HUC10_cropland_area_1': 19.55412805,
    'HUC12_developed_area_5': 9.980074256
}

coefficients = {
    'intercept': 2.02081812,
    'AVFST_Max': -0.087273219,
    'ARAIN_Average': -0.11073558,
    'HUC12_forest_and_shrubland_4': -1.838215588,
    'HUC10_grassland_and_pasture_3': -4.606993536,
    'HUC10_cropland_area_1': -2.244588404,
    'HUC12_developed_area_5': -0.006911962
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Weohyakapka.")
