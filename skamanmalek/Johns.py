...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Johns Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 10.16050871,
    'AVFST_Max': 88.106,
    'ARAIN_Average': 184.16,
    'HUC12_forest_and_shrubland_4': 2.972667164,
    'HUC10_grassland_and_pasture_3': 12.92275406,
    'HUC10_cropland_area_1': 3.332721843,
    'HUC12_developed_area_5': 53.6480984
}

coefficients = {
    'intercept': 0.29158858,
    'AVFST_Max': -0.055240419,
    'ARAIN_Average': -0.023390625,
    'HUC12_forest_and_shrubland_4': -0.641369667,
    'HUC10_grassland_and_pasture_3': -0.765467164,
    'HUC10_cropland_area_1': -0.599754037,
    'HUC12_developed_area_5': -0.03697118
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Johns Lake.")
