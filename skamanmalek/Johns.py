...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Johns</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Initial values according to the baseline of 2022 for Lake Apopka
initial_values = {
    'Norm_CyAN': -1.327879602,
    'AVFST_Max': 88.106,
    'ARAIN_Average': 184.16,
    'HUC12_TN': 173.8642877,
...
coefficients = {
    'intercept': 1.808337693,
    'AVFST_Max': 0.010722279,
    'ARAIN_Average': -0.148217257,
    'HUC12_TN': -1.585776803,
    'HUC10_TP': -0.893386903,
    'HUC10_cropland_area_1': -0.352106785,
    'HUC12_developed_area_5': -0.423284624
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Johns.")
