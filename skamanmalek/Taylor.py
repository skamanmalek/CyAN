...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Taylor Creek</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 2.20791276,
    'AVFST_Max': 86.612,
    'ARAIN_Average': 210.15,
    'HUC12_forest_and_shrubland_4': 5.164215065,
    'HUC10_grassland_and_pasture_3': 32.71662666,
    'HUC10_cropland_area_1': 0.223292897,
    'HUC12_developed_area_5': 0.761634542
}

coefficients = {
    'intercept': 0.001568781,
    'AVFST_Max': -0.015419025,
    'ARAIN_Average': 0.089774713,
    'HUC12_forest_and_shrubland_4': -0.049636028,
    'HUC10_grassland_and_pasture_3': -0.121309795,
    'HUC10_cropland_area_1': -0.112377884,
    'HUC12_developed_area_5': 0.078584789
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Taylor Creek.")
