...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Kerr</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 2.325022737,
    'AVFST_Max': 86.216,
    'ARAIN_Average': 175.95,
    'HUC12_forest_and_shrubland_4': 63.49735954,
    'HUC10_grassland_and_pasture_3': 3.864405555,
    'HUC10_cropland_area_1': 0.133390343,
    'HUC12_developed_area_5': 8.928382284
}

coefficients = {
    'intercept': -2.871217019,
    'AVFST_Max': 0.193709295,
    'ARAIN_Average': -0.205749594,
    'HUC12_forest_and_shrubland_4': 3.100115665,
    'HUC10_grassland_and_pasture_3': -0.021328188,
    'HUC10_cropland_area_1': 0.697729739,
    'HUC12_developed_area_5': 3.439349509
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Kerr.")
