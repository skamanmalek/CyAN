...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Lowry</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 0.980958871,
    'AVFST_Max': 85.766,
    'ARAIN_Average': 174.24,
    'HUC12_forest_and_shrubland_4': 45.91302679,
    'HUC10_grassland_and_pasture_3': 12.95983827,
    'HUC10_cropland_area_1': 1.801128932,
    'HUC12_developed_area_5': 18.2590594
}

coefficients = {
    'intercept': -0.003365895,
    'AVFST_Max': -0.014750235,
    'ARAIN_Average': -0.004046267,
    'HUC12_forest_and_shrubland_4': 0.022484952,
    'HUC10_grassland_and_pasture_3': -0.010268076,
    'HUC10_cropland_area_1': 0.011368146,
    'HUC12_developed_area_5': 0.017073837
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Lowry.")
