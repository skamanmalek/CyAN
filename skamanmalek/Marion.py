...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Marion</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 131.754442,
    'AVFST_Max': 87.332,
    'ARAIN_Average': 181.83,
    'HUC12_forest_and_shrubland_4': 1.499991002,
    'HUC10_grassland_and_pasture_3': 13.04818346,
    'HUC10_cropland_area_1': 8.366960555,
    'HUC12_developed_area_5': 29.51392013
}

coefficients = {
    'intercept': 1.014352276,
    'AVFST_Max': 0.143380544,
    'ARAIN_Average': -0.076617754,
    'HUC12_forest_and_shrubland_4': 0.334627383,
    'HUC10_grassland_and_pasture_3': -1.639694051,
    'HUC10_cropland_area_1': -0.361751573,
    'HUC12_developed_area_5': -0.287461382
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Marion.")
