...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in George Lakes</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 25.68559884,
    'AVFST_Max': 85.964,
    'ARAIN_Average': 175.32,
    'HUC12_forest_and_shrubland_4': 67.83656991,
    'HUC10_grassland_and_pasture_3': 6.297960662,
    'HUC10_cropland_area_1': 0.135890583,
    'HUC12_developed_area_5': 8.875999298
}

coefficients = {
    'intercept': 3.513633501,
    'AVFST_Max': 0.103886006,
    'ARAIN_Average': -0.14176152,
    'HUC12_forest_and_shrubland_4': -2.914563545,
    'HUC10_grassland_and_pasture_3': -3.03101082,
    'HUC10_cropland_area_1': 6.25257515,
    'HUC12_developed_area_5': -6.438022429
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for George Lakes.")
