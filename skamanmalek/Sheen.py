...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Sheene</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 1.033276559,
    'AVFST_Max': 86.09,
...
coefficients = {
    'intercept': 0.042953432,
    'AVFST_Max': -0.004259356,
    'ARAIN_Average': -0.00596613,
    'HUC12_forest_and_shrubland_4': 0.020537045,
    'HUC10_grassland_and_pasture_3': -0.198058294,
    'HUC10_cropland_area_1': -0.053330872,
    'HUC12_developed_area_5': -0.015587313
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Sheen.")
