...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Manatee</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 7.008305892,
    'AVFST_Max': 85.532,
    'ARAIN_Average': 181.1,
    'HUC12_forest_and_shrubland_4': 5.752760563,
    'HUC10_grassland_and_pasture_3': 40.56765003,
    'HUC10_cropland_area_1': 7.181318434,
    'HUC12_developed_area_5': 11.21020333
}

coefficients = {
    'intercept': 0.217719685,
    'AVFST_Max': -0.041511082,
    'ARAIN_Average': -0.077433446,
    'HUC12_forest_and_shrubland_4': -0.080405841,
    'HUC10_grassland_and_pasture_3': -0.383213364,
    'HUC10_cropland_area_1': -0.458238626,
    'HUC12_developed_area_5': 0.653435583
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Manatee.")
