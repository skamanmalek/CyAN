...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Pate</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 7.145636462,
    'AVFST_Max': 85.172,
    'ARAIN_Average': 169.08,
    'HUC12_forest_and_shrubland_4': 43.87591475,
    'HUC10_grassland_and_pasture_3': 2.630055712,
    'HUC10_cropland_area_1': 7.276711423,
    'HUC12_developed_area_5': 6.715453317
}

coefficients = {
    'intercept': -0.048628704,
    'AVFST_Max': -0.002312972,
    'ARAIN_Average': -0.035036357,
    'HUC12_forest_and_shrubland_4': -0.014957702,
    'HUC10_grassland_and_pasture_3': -0.028808652,
    'HUC10_cropland_area_1': 0.049259002,
    'HUC12_developed_area_5': 1.123251077
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Pate.")
