...
initial_values = {
    ...
    'HUC10_cropland_area_1': 0.000000000,
    'HUC12_developed_area_5': 0.056778731
}

coefficients = {
    'intercept': -0.011674624,
    'AVFST_Max': 0.010840572,
    'ARAIN_Average': 0.01398387,
    'HUC12_forest_and_shrubland_4': 28.35298806,
    'HUC10_grassland_and_pasture_3': -37.04465762,
    'HUC10_cropland_area_1': -0.000813478,
    'HUC12_developed_area_5': -5.501258077
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Alligator Bay/Dads Bay.")
