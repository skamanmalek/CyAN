...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Ingraham</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 24.40240673,
    'AVFST_Max': 85.082,
    'ARAIN_Average': 206.5,
...
coefficients = {
    'intercept': 0.534505228,
    'AVFST_Max': -0.058438979,
    'ARAIN_Average': -0.484621082,
    'HUC12_forest_and_shrubland_4': 488.2260276,
    'HUC10_grassland_and_pasture_3': -336.7236048,
    'HUC10_cropland_area_1': -0.171204251,
    'HUC12_developed_area_5': -117.3844742
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Ingraham.")
