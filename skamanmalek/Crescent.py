...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Crescent Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 40.2035903,
    'AVFST_Max': 86.342,
    'ARAIN_Average': 176.14,
    'HUC12_forest_and_shrubland_4': 37.45694906,
    'HUC10_grassland_and_pasture_3': 7.582637294,
    'HUC10_cropland_area_1': 1.320567422,
    'HUC12_developed_area_5': 5.793746246
}

coefficients = {
    'intercept': -0.558338735,
    'AVFST_Max': 0.402121679,
    'ARAIN_Average': 0.25083352,
    'HUC12_forest_and_shrubland_4': 1.431361313,
    'HUC10_grassland_and_pasture_3': 0.41677829,
    'HUC10_cropland_area_1': -0.518928718,
    'HUC12_developed_area_5': -2.489769715
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Crescent Lake.")
