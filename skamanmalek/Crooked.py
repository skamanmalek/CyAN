...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Crooked Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 6.074454404,
    'AVFST_Max': 85.424,
    'ARAIN_Average': 177.2,
    'HUC12_forest_and_shrubland_4': 4.4971101,
    'HUC10_grassland_and_pasture_3': 7.860022176,
    'HUC10_cropland_area_1': 22.48329033,
    'HUC12_developed_area_5': 10.59550881
}

coefficients = {
    'intercept': 0.083536427,
    'AVFST_Max': -0.080016588,
    'ARAIN_Average': 0.023827444,
    'HUC12_forest_and_shrubland_4': 1.402749859,
    'HUC10_grassland_and_pasture_3': 0.27381177,
    'HUC10_cropland_area_1': -0.04434388,
    'HUC12_developed_area_5': -0.904928773
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Crooked Lake.")
