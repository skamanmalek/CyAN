...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Cypress Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 49.45467944,
    'AVFST_Max': 85.964,
    'ARAIN_Average': 181.16,
    'HUC12_forest_and_shrubland_4': 1.981960598,
    'HUC10_grassland_and_pasture_3': 32.28017088,
    'HUC10_cropland_area_1': 4.111972914,
    'HUC12_developed_area_5': 0.529872523
}

coefficients = {
    'intercept': 1.010462288,
    'AVFST_Max': -0.038127784,
    'ARAIN_Average': -0.076158626,
    'HUC12_forest_and_shrubland_4': 0.04394439,
    'HUC10_grassland_and_pasture_3': -1.22541824,
    'HUC10_cropland_area_1': -0.913490123,
    'HUC12_developed_area_5': -31.29012597
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Cypress Lake.")
