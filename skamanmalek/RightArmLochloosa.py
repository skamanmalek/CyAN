...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Arm Lochloosa Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 76.20239724,
    'AVFST_Max': 86.198,
    'ARAIN_Average': 173.65,
    'HUC12_forest_and_shrubland_4': 52.08005022,
    'HUC10_grassland_and_pasture_3': 22.95973081,
    'HUC10_cropland_area_1': 1.914642781,
    'HUC12_developed_area_5': 4.061273004
}

coefficients = {
    'intercept': -0.571825006,
    'AVFST_Max': -0.048010113,
    'ARAIN_Average': -0.212676001,
    'HUC12_forest_and_shrubland_4': 1.811096431,
    'HUC10_grassland_and_pasture_3': 1.738424053,
    'HUC10_cropland_area_1': -2.054063416,
    'HUC12_developed_area_5': -11.79160346
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Arm Lochloosa Lake.")
