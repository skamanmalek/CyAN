...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Buffum</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 20.81190493,
    'AVFST_Max': 85.622,
    'ARAIN_Average': 180.1,
    'HUC12_forest_and_shrubland_4': 4.260192147,
    'HUC10_grassland_and_pasture_3': 28.33539305,
    'HUC10_cropland_area_1': 16.17038627,
    'HUC12_developed_area_5': 4.266720343
}

coefficients = {
    'intercept': 0.176701424,
    'AVFST_Max': 0.061943001,
    'ARAIN_Average': 0.120017526,
    'HUC12_forest_and_shrubland_4': -0.464723854,
    'HUC10_grassland_and_pasture_3': 0.038877009,
    'HUC10_cropland_area_1': -0.49601469,
    'HUC12_developed_area_5': -0.447365026
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Buffum.")
