...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Tibet</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 1.767313475,
    'AVFST_Max': 86.09,
...
coefficients = {
    'intercept': 0.058790623,
    'AVFST_Max': -0.002966333,
    'ARAIN_Average': -0.014108828,
    'HUC12_forest_and_shrubland_4': -0.066166542,
    'HUC10_grassland_and_pasture_3': -0.240911678,
    'HUC10_cropland_area_1': -0.06768524,
    'HUC12_developed_area_5': -0.01954913
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Tibet.")
