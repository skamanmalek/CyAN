...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Dorr</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 9.64921849,
    'AVFST_Max': 85.586,
    'ARAIN_Average': 177.04,
    'HUC12_forest_and_shrubland_4': 59.19554678,
    'HUC10_grassland_and_pasture_3': 21.73072547,
    'HUC10_cropland_area_1': 2.650514685,
    'HUC12_developed_area_5': 8.870533309
}

coefficients = {
    'intercept': 0.208494719,
    'AVFST_Max': -0.076300667,
    'ARAIN_Average': 0.006000523,
    'HUC12_forest_and_shrubland_4': 0.01006675,
    'HUC10_grassland_and_pasture_3': -0.834050085,
    'HUC10_cropland_area_1': 0.138006734,
    'HUC12_developed_area_5': 0.734411141
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Dorr.")
