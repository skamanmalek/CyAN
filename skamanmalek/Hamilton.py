...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Hamilton</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 136.0578005,
    'AVFST_Max': 87.602,
...
coefficients = {
    'intercept': -2.143435681,
    'AVFST_Max': -0.348921381,
    'ARAIN_Average': -0.103324184,
    'HUC12_forest_and_shrubland_4': 4.720504489,
    'HUC10_grassland_and_pasture_3': -0.479489768,
    'HUC10_cropland_area_1': -1.40018634,
    'HUC12_developed_area_5': 7.563874583
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Hamilton.")
