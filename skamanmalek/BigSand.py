...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Big Sand Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 0.738043228,
    'AVFST_Max': 85.964,
    'ARAIN_Average': 184.88,
    'HUC12_forest_and_shrubland_4': 1.52340059,
    'HUC10_grassland_and_pasture_3': 4.522024881,
    'HUC10_cropland_area_1': 0.329238714,
    'HUC12_developed_area_5': 78.27900728
}

coefficients = {
    'intercept': 0.055767892,
    'AVFST_Max': -0.006012328,
    'ARAIN_Average': 0.00576686,
    'HUC12_forest_and_shrubland_4': -0.03299358,
    'HUC10_grassland_and_pasture_3': -0.221196832,
    'HUC10_cropland_area_1': -0.054712979,
    'HUC12_developed_area_5': -0.038726934
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Big Sand Lake.")
