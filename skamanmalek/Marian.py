...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Marian</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 83.87231874,
    'AVFST_Max': 85.352,
    'ARAIN_Average': 183.26,
    'HUC12_forest_and_shrubland_4': 15.1535075,
    'HUC10_grassland_and_pasture_3': 28.12169057,
    'HUC10_cropland_area_1': 0.850175145,
    'HUC12_developed_area_5': 2.309541766
}

coefficients = {
    'intercept': -0.178741653,
    'AVFST_Max': -0.015324578,
    'ARAIN_Average': 0.33783976,
    'HUC12_forest_and_shrubland_4': 0.456786835,
    'HUC10_grassland_and_pasture_3': 0.300790019,
    'HUC10_cropland_area_1': 0.335506617,
    'HUC12_developed_area_5': 11.02007854
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Marian.")
