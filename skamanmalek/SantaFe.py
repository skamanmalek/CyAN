...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Santa Fe Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 9.867992197,
    'AVFST_Max': 85.172,
    'ARAIN_Average': 174.53,
    'HUC12_forest_and_shrubland_4': 42.42316805,
    'HUC10_grassland_and_pasture_3': 8.671984082,
    'HUC10_cropland_area_1': 1.012042381,
    'HUC12_developed_area_5': 7.221869995
}

coefficients = {
    'intercept': 0.139323328,
    'AVFST_Max': 0.00491733,
    'ARAIN_Average': -0.194084751,
    'HUC12_forest_and_shrubland_4': -0.07500049,
    'HUC10_grassland_and_pasture_3': -0.110474203,
    'HUC10_cropland_area_1': 0.163814135,
    'HUC12_developed_area_5': -0.065015258
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Santa Fe Lake.")
