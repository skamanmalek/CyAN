...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Banana River</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 89.31234439,
    'AVFST_Max': 85.622,
    'ARAIN_Average': 212.22,
    'HUC12_forest_and_shrubland_4': 1.800042515,
    'HUC10_grassland_and_pasture_3': 0.863904677,
    'HUC10_cropland_area_1': 0.15735826,
    'HUC12_developed_area_5': 13.45095821
}

coefficients = {
    'intercept': 5.014732161,
    'AVFST_Max': -0.243844714,
    'ARAIN_Average': -0.499673603,
    'HUC12_forest_and_shrubland_4': -0.004421103,
    'HUC10_grassland_and_pasture_3': 5.89570518,
    'HUC10_cropland_area_1': 0.057466578,
    'HUC12_developed_area_5': -24.35837471
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Banana River.")
