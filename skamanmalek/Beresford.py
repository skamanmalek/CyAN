...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Beresford</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 17.95310367,
    'AVFST_Max': 86.09,
    'ARAIN_Average': 182.55,
    'HUC12_forest_and_shrubland_4': 24.09923799,
    'HUC10_grassland_and_pasture_3': 4.2289825,
    'HUC10_cropland_area_1': 0.180681591,
    'HUC12_developed_area_5': 15.4109589
}

coefficients = {
    'intercept': -0.009093764,
    'AVFST_Max': 0.013815878,
    'ARAIN_Average': 0.106614886,
    'HUC12_forest_and_shrubland_4': 0.173294222,
    'HUC10_grassland_and_pasture_3': 0.005436641,
    'HUC10_cropland_area_1': -0.102512736,
    'HUC12_developed_area_5': 0.050911294
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Beresford.")
