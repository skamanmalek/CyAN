...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Russell</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 5.640044457,
    'AVFST_Max': 85.838,
    'ARAIN_Average': 180.91,
    'HUC12_forest_and_shrubland_4': 5.353316059,
    'HUC10_grassland_and_pasture_3': 13.662969,
    'HUC10_cropland_area_1': 1.678408075,
    'HUC12_developed_area_5': 1.67378668
}

coefficients = {
    'intercept': 0.157247731,
    'AVFST_Max': -0.015622492,
    'ARAIN_Average': 0.035842458,
    'HUC12_forest_and_shrubland_4': -0.076648043,
    'HUC10_grassland_and_pasture_3': -0.751693909,
    'HUC10_cropland_area_1': -0.210417788,
    'HUC12_developed_area_5': 0.17926517
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Russell.")
