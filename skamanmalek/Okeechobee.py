...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Okeechobee</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 11.46461538,
    'AVFST_Max': 85.55,
    'ARAIN_Average': 192.03,
    'HUC12_forest_and_shrubland_4': 0.765651728,
    'HUC10_grassland_and_pasture_3': 22.82903105,
    'HUC10_cropland_area_1': 11.51318437,
    'HUC12_developed_area_5': 2.959581041
}

coefficients = {
    'intercept': 1.063042771,
    'AVFST_Max': 0.14298563,
    'ARAIN_Average': 0.370986781,
    'HUC12_forest_and_shrubland_4': 9.492808435,
    'HUC10_grassland_and_pasture_3': -2.782307269,
    'HUC10_cropland_area_1': -3.581747848,
    'HUC12_developed_area_5': -1.915564355
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Okeechobee.")
