...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Weir</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': -0.359695231,
    'AVFST_Max': 86.324,
    'ARAIN_Average': 175.09,
    'HUC12_forest_and_shrubland_4': 13.1185006,
    'HUC10_grassland_and_pasture_3': 11.17240381,
    'HUC10_cropland_area_1': 0.873193241,
    'HUC12_developed_area_5': 45.63323098
}

coefficients = {
    'intercept': 0.317087782,
    'AVFST_Max': 0.595795483,
    'ARAIN_Average': 0.688753704,
    'HUC12_forest_and_shrubland_4': 0.788256243,
    'HUC10_grassland_and_pasture_3': -1.056794407,
    'HUC10_cropland_area_1': 2.316440601,
    'HUC12_developed_area_5': -1.297152373
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Weir.")
