...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Eagle Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 62.16871162,
    'AVFST_Max': 87.476,
    'ARAIN_Average': 179.34,
    'HUC12_forest_and_shrubland_4': 1.44259679,
    'HUC10_grassland_and_pasture_3': 11.92659881,
    'HUC10_cropland_area_1': 4.35476106,
    'HUC12_developed_area_5': 35.61219298
}

coefficients = {
    'intercept': 0.272374864,
    'AVFST_Max': -0.248962869,
    'ARAIN_Average': -0.125696341,
    'HUC12_forest_and_shrubland_4': 1.673685008,
    'HUC10_grassland_and_pasture_3': -1.251295751,
    'HUC10_cropland_area_1': -2.025718949,
    'HUC12_developed_area_5': 1.090977771
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Eagle Lake.")
