...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Washington</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 13.81183252,
    'AVFST_Max': 85.784,
    'ARAIN_Average': 212.57,
    'HUC12_forest_and_shrubland_4': 0.407536659,
    'HUC10_grassland_and_pasture_3': 39.6470097,
    'HUC10_cropland_area_1': 0.613085929,
    'HUC12_developed_area_5': 17.63802831
}

coefficients = {
    'intercept': -0.215762043,
    'AVFST_Max': -0.045445341,
    'ARAIN_Average': 0.04063371,
    'HUC12_forest_and_shrubland_4': 1.263858311,
    'HUC10_grassland_and_pasture_3': -0.042612679,
    'HUC10_cropland_area_1': -0.075605432,
    'HUC12_developed_area_5': 1.299358178
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Washington.")
