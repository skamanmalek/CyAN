...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Big Blue Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 1.043504323,
    'AVFST_Max': 85.478,
    'ARAIN_Average': 169.59,
    'HUC12_forest_and_shrubland_4': 58.34384095,
    'HUC10_grassland_and_pasture_3': 3.424826495,
    'HUC10_cropland_area_1': 0.833382077,
    'HUC12_developed_area_5': 5.383084637
}

coefficients = {
    'intercept': -0.047620097,
    'AVFST_Max': 0.00266723,
    'ARAIN_Average': -0.004431797,
    'HUC12_forest_and_shrubland_4': -0.029783629,
    'HUC10_grassland_and_pasture_3': -0.007563488,
    'HUC10_cropland_area_1': 0.045210224,
    'HUC12_developed_area_5': 1.099393352
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Big Blue Lake.")
