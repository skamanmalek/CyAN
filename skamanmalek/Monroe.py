...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Monroe</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 81.81704168,
    'AVFST_Max': 88.394,
...
coefficients = {
    'intercept': 0.542297024,
    'AVFST_Max': 0.64319551,
    'ARAIN_Average': -0.475439409,
    'HUC12_forest_and_shrubland_4': 461.8311554,
    'HUC10_grassland_and_pasture_3': -575.6975653,
    'HUC10_cropland_area_1': -0.161630711,
    'HUC12_developed_area_5': -596.5389989
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Monroe.")
