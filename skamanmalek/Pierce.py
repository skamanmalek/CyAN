...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Pierce</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 146.1897996,
    'AVFST_Max': 87.17,
    'ARAIN_Average': 178.34,
    'HUC12_forest_and_shrubland_4': 2.912697675,
    'HUC10_grassland_and_pasture_3': 14.6086726,
    'HUC10_cropland_area_1': 35.27317272,
    'HUC12_developed_area_5': 12.82630289
}

coefficients = {
    'intercept': 1.585897859,
    'AVFST_Max': -0.637098946,
    'ARAIN_Average': -0.171972595,
    'HUC12_forest_and_shrubland_4': 0.077421363,
    'HUC10_grassland_and_pasture_3': 0.252312669,
    'HUC10_cropland_area_1': -0.863962573,
    'HUC12_developed_area_5': -0.726234734
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Pierce.")
