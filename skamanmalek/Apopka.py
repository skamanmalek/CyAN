...
initial_values = {
    'Norm_CyAN': 141.348472996939,
    'HUC10_cropland_area_1': 3.332722,
    'HUC10_grassland_and_pasture_3': 12.92275406,
    'HUC12_forest_and shrubland_4': 4.51122771123869,
    'HUC12_developed_area_5': 27.2751388277394,
...
coefficients = {
    'intercept': 2.70726132929382,
    'HUC10_cropland_area_1': -2.88231959470455,
    'HUC10_grassland_and_pasture_3': -5.51461513732534,
    'HUC12_forest_and shrubland_4': -0.363781812401769,
    'HUC12_developed_area_5': -2.83642949763278,
    'ARAIN_Average': -0.112755288853199,
    'AVFST_Max': 0.0579135365714828,
}
...
HUC12_Forest_&_shrubland_user = st.sidebar.slider("**🔍 Forest_&_shrubland_%***", d3, d4, initial_values['HUC12_TN'], step=0.1, key="huc12_tn", help="Adjust total nitrogen.")
