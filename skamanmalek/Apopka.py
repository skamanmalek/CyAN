...
HUC12_forest_and_shrubland_4_user = st.sidebar.slider("**🔍 HUC12_Forest_and_Shrubland_4_mg/L**", d3, d4, initial_values['HUC12_forest_and_shrubland_4'], step=0.1, key="huc12_forest_shrubland", help="Adjust total nitrogen for forest and shrubland.")
HUC10_grassland_and_pasture_3_user = st.sidebar.slider("**📊 HUC10_Grassland_and_Pasture_3_mg/L**", e3, e4, initial_values['HUC10_grassland_and_pasture_3'], step=0.1, key="huc10_grassland_pasture", help="Adjust total phosphorus for grassland and pasture.")
