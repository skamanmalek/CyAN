...
#Slider variables:
b3, c3, d3, e3, f3, g3 = 67.00, 163.72, 14.37253718, 7.105387318, 0, 0.052616068
b4, c4, d4, e4, f4, g4 = 106.00, 223.83, 252.0831295, 24.93183214, 86.75640259, 79.36556518


# User Input
AVFST_Max_user = st.slider("AVFST_Max User Input (°F)", b3, b4, initial_values['AVFST_Max'])
