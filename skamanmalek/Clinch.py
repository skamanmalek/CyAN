...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Clinch</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 20.71826744,
    'AVFST_Max': 85.64,
    'ARAIN_Average': 179.37,
    'HUC12_forest_and_shrubland_4': 6.369478073,
    'HUC10_grassland_and_pasture_3': 7.860022176,
    'HUC10_cropland_area_1': 22.48329033,
    'HUC12_developed_area_5': 13.71593175
}

coefficients = {
    'intercept': -0.080152956,
    'AVFST_Max': -0.208597177,
    'ARAIN_Average': 0.146522451,
    'HUC12_forest_and_shrubland_4': -0.458767242,
    'HUC10_grassland_and_pasture_3': -1.774733989,
    'HUC10_cropland_area_1': 1.387473065,
    'HUC12_developed_area_5': 0.476533085
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Clinch.")
