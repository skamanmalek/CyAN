...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Louisa</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 3.491934351,
    'AVFST_Max': 87.782,
    'ARAIN_Average': 184.06,
    'HUC12_forest_and_shrubland_4': 3.464111883,
    'HUC10_grassland_and_pasture_3': 21.97415169,
    'HUC10_cropland_area_1': 7.781039427,
    'HUC12_developed_area_5': 14.37710487
}

coefficients = {
    'intercept': 0.103478193,
    'AVFST_Max': -0.022856743,
    'ARAIN_Average': -0.00222169,
    'HUC12_forest_and_shrubland_4': -0.18645283,
    'HUC10_grassland_and_pasture_3': -0.143870516,
    'HUC10_cropland_area_1': -0.154759501,
    'HUC12_developed_area_5': -0.050339637
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Louisa.")
