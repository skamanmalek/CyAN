...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Center</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 9.016933993,
    'AVFST_Max': 86.000000000,
    'ARAIN_Average': 183.83,
    'HUC12_forest_and_shrubland_4': 3.388103013,
    'HUC10_grassland_and_pasture_3': 32.28017088,
    'HUC10_cropland_area_1': 4.111972914,
    'HUC12_developed_area_5': 19.80472478
}

coefficients = {
    'intercept': 0.231968481,
    'AVFST_Max': 0.033865152,
    'ARAIN_Average': -0.037116525,
    'HUC12_forest_and_shrubland_4': -0.534507962,
    'HUC10_grassland_and_pasture_3': 0.573381388,
    'HUC10_cropland_area_1': 0.366565228,
    'HUC12_developed_area_5': -1.648571506
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Center.")
