...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Livingston</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 8.577872705,
    'AVFST_Max': 85.64,
    'ARAIN_Average': 179.37,
    'HUC12_forest_and_shrubland_4': 5.01722583,
    'HUC10_grassland_and_pasture_3': 7.860022176,
    'HUC10_cropland_area_1': 22.48329033,
    'HUC12_developed_area_5': 11.16662017
}

coefficients = {
    'intercept': -1.197180178,
    'AVFST_Max': 0.034326008,
    'ARAIN_Average': 0.130913112,
    'HUC12_forest_and_shrubland_4': 2.355972536,
    'HUC10_grassland_and_pasture_3': 1.749461538,
    'HUC10_cropland_area_1': -0.039747672,
    'HUC12_developed_area_5': 6.334257266
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Livingston.")
