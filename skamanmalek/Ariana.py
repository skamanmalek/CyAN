...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Ariana</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 104.7651955,
    'AVFST_Max': 85.874,
...
coefficients = {
    'intercept': 0.921764194,
    'AVFST_Max': -0.108731556,
    'ARAIN_Average': -0.27312793,
    'HUC12_forest_and_shrubland_4': -2.501964458,
    'HUC10_grassland_and_pasture_3': -3.834788267,
    'HUC10_cropland_area_1': -2.568097508,
    'HUC12_developed_area_5': 0.806651089
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Ariana.")
