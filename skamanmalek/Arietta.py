...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Arietta</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 31.53334014,
    'AVFST_Max': 85.874,
    'ARAIN_Average': 179.71,
    'HUC12_forest_and_shrubland_4': 1.577214734,
    'HUC10_grassland_and_pasture_3': 11.92659881,
    'HUC10_cropland_area_1': 4.35476106,
    'HUC12_developed_area_5': 47.05275398
}

coefficients = {
    'intercept': -0.607533622,
    'AVFST_Max': 0.018269821,
    'ARAIN_Average': -0.473215762,
    'HUC12_forest_and_shrubland_4': -0.410328869,
    'HUC10_grassland_and_pasture_3': -0.543787075,
    'HUC10_cropland_area_1': -0.452176784,
    'HUC12_developed_area_5': 1.684827924
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Arietta.")
