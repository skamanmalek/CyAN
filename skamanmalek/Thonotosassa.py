...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Thonotosassa</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 113.2435324,
    'AVFST_Max': 85.982,
    'ARAIN_Average': 176.84,
    'HUC12_forest_and_shrubland_4': 4.473511636,
    'HUC10_grassland_and_pasture_3': 17.26396728,
    'HUC10_cropland_area_1': 5.539399996,
    'HUC12_developed_area_5': 33.58855745
}

coefficients = {
    'intercept': 0.50605251,
    'AVFST_Max': -0.220925502,
    'ARAIN_Average': 0.593477431,
    'HUC12_forest_and_shrubland_4': -2.199154588,
    'HUC10_grassland_and_pasture_3': 0.411901547,
    'HUC10_cropland_area_1': 0.464754853,
    'HUC12_developed_area_5': 0.123113999
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Thonotosassa.")
