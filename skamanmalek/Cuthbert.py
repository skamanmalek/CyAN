...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Cuthbert Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 124.8056009,
    'AVFST_Max': 88.484,
    'ARAIN_Average': 189.75,
...
coefficients = {
    'intercept': 1.752290301,
    'AVFST_Max': -1.209846243,
    'ARAIN_Average': -0.225255918,
    'HUC12_forest_and_shrubland_4': 1058.49109,
    'HUC10_grassland_and_pasture_3': -394.9144547,
    'HUC10_cropland_area_1': 0.081642389,
    'HUC12_developed_area_5': -417.4141453
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Cuthbert Lake.")
