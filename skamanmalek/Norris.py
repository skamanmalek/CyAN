...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Norris</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 6.167872993,
    'AVFST_Max': 86.198,
    'ARAIN_Average': 177.94,
    'HUC12_forest_and_shrubland_4': 26.26807752,
    'HUC10_grassland_and_pasture_3': 21.73072547,
    'HUC10_cropland_area_1': 2.650514685,
    'HUC12_developed_area_5': 7.783250458
}

coefficients = {
    'intercept': 0.098235025,
    'AVFST_Max': -0.036877397,
    'ARAIN_Average': 0.004658676,
    'HUC12_forest_and_shrubland_4': 0.023167062,
    'HUC10_grassland_and_pasture_3': -0.605360161,
    'HUC10_cropland_area_1': 0.186942024,
    'HUC12_developed_area_5': 1.007399825
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Norris.")
