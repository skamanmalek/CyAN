...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Norris Apopka</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Initial values according to the baseline of 2022 for Lake Apopka
initial_values = {
    'Norm_CyAN': 7.217496517,
    'AVFST_Max': 86.198,
    'ARAIN_Average': 177.94,
    'HUC12_TN': 146.6068076,
    'HUC10_TP': 16.5406533,
...
coefficients = {
    'intercept': 0.161508108,
    'AVFST_Max': -0.061612325,
    'ARAIN_Average': 0.0318954,
    'HUC12_TN': -0.020382122,
    'HUC10_TP': -0.384283349,
    'HUC10_cropland_area_1': -0.003888635,
    'HUC12_developed_area_5': 1.149476301
}
