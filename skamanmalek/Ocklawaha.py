...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Ocklawaha</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
    'Norm_CyAN': 5.239994773,
    'AVFST_Max': 86.738,
    'ARAIN_Average': 170.91,
    'HUC12_forest_and_shrubland_4': 51.36202352,
    'HUC10_grassland_and_pasture_3': 12.83831669,
    'HUC10_cropland_area_1': 0.978745301,
    'HUC12_developed_area_5': 9.447340341
}

coefficients = {
    'intercept': -0.158063738,
    'AVFST_Max': 0.009951539,
    'ARAIN_Average': -0.011542332,
    'HUC12_forest_and_shrubland_4': 0.104406816,
    'HUC10_grassland_and_pasture_3': 0.013175805,
    'HUC10_cropland_area_1': -0.041507328,
    'HUC12_developed_area_5': 0.952614421
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Ocklawaha.")
