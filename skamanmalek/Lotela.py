...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Lotela</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 9.469651564,
    'AVFST_Max': 85.928,
    'ARAIN_Average': 182.24,
    'HUC12_forest_and_shrubland_4': 3.474553277,
    'HUC10_grassland_and_pasture_3': 21.95034812,
    'HUC10_cropland_area_1': 16.25679087,
    'HUC12_developed_area_5': 30.20427148
}

coefficients = {
    'intercept': 0.74016358,
    'AVFST_Max': 0.007664797,
    'ARAIN_Average': 0.102877989,
    'HUC12_forest_and_shrubland_4': 2.257057639,
    'HUC10_grassland_and_pasture_3': -0.692702671,
    'HUC10_cropland_area_1': -1.756796421,
    'HUC12_developed_area_5': -0.810064556
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Lotela.")
