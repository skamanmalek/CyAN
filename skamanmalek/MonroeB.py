...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Monroe (2)</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 18.94719602,
    'AVFST_Max': 85.946,
    'ARAIN_Average': 184.77,
    'HUC12_forest_and_shrubland_4': 5.277570058,
    'HUC10_grassland_and_pasture_3': 3.251355021,
    'HUC10_cropland_area_1': 0.245122503,
    'HUC12_developed_area_5': 39.68452935
}

coefficients = {
    'intercept': 0.284389794,
    'AVFST_Max': -0.10946291,
    'ARAIN_Average': 0.372731028,
    'HUC12_forest_and_shrubland_4': -0.227343381,
    'HUC10_grassland_and_pasture_3': -2.618418739,
    'HUC10_cropland_area_1': 0.044784737,
    'HUC12_developed_area_5': -0.298973728
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Monroe (2).")
