...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Bryant</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': -0.149088349,
    'AVFST_Max': 85.766,
    'ARAIN_Average': 173.72,
    'HUC12_forest_and_shrubland_4': 63.18001704,
    'HUC10_grassland_and_pasture_3': 6.526100307,
    'HUC10_cropland_area_1': 0.084019403,
    'HUC12_developed_area_5': 11.20986557
}

coefficients = {
    'intercept': -1.351546846,
    'AVFST_Max': 0.07117956,
    'ARAIN_Average': 0.163887849,
    'HUC12_forest_and_shrubland_4': 1.419391917,
    'HUC10_grassland_and_pasture_3': 1.311357971,
    'HUC10_cropland_area_1': -3.941428116,
    'HUC12_developed_area_5': 0.545291271
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Bryant.")
