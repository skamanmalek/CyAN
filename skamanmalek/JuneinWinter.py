...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake June in Winter</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 33.2250066,
    'AVFST_Max': 85.532,
    'ARAIN_Average': 181.54,
    'HUC12_forest_and_shrubland_4': 7.125855109,
    'HUC10_grassland_and_pasture_3': 7.618479909,
    'HUC10_cropland_area_1': 22.79390733,
    'HUC12_developed_area_5': 26.53854431
}

coefficients = {
    'intercept': -3.032705659,
    'AVFST_Max': -0.02899917,
    'ARAIN_Average': 0.433119159,
    'HUC12_forest_and_shrubland_4': 2.343634928,
    'HUC10_grassland_and_pasture_3': -1.390158291,
    'HUC10_cropland_area_1': 1.236374937,
    'HUC12_developed_area_5': 8.039074509
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake June in Winter.")
