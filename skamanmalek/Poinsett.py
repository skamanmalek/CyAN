...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Poinsett</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 5.399208844,
    'AVFST_Max': 86.09,
    'ARAIN_Average': 212.67,
    'HUC12_forest_and_shrubland_4': 1.136431534,
    'HUC10_grassland_and_pasture_3': 32.71662666,
    'HUC10_cropland_area_1': 0.223292897,
    'HUC12_developed_area_5': 23.11197013
}

coefficients = {
    'intercept': 0.026911492,
    'AVFST_Max': -0.127440228,
    'ARAIN_Average': 0.190771346,
    'HUC12_forest_and_shrubland_4': 1.142863159,
    'HUC10_grassland_and_pasture_3': -0.30253563,
    'HUC10_cropland_area_1': -0.23158831,
    'HUC12_developed_area_5': 0.034874137
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Poinsett.")
