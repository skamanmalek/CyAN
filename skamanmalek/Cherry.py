...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Cherry Lake</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 2.628357874,
    'AVFST_Max': 84.614,
    'ARAIN_Average': 167.76,
    'HUC12_forest_and_shrubland_4': 48.68062218,
    'HUC10_grassland_and_pasture_3': 13.05674146,
    'HUC10_cropland_area_1': 17.11306922,
    'HUC12_developed_area_5': 6.473466924
}

coefficients = {
    'intercept': -0.104064632,
    'AVFST_Max': 0.056077956,
    'ARAIN_Average': 0.048117481,
    'HUC12_forest_and_shrubland_4': 0.209739736,
    'HUC10_grassland_and_pasture_3': 0.011613765,
    'HUC10_cropland_area_1': 0.024317661,
    'HUC12_developed_area_5': -0.440292873
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Cherry Lake.")
