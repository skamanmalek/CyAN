...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Minneola</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 9.892587635,
    'AVFST_Max': 86.09,
    'ARAIN_Average': 182.28,
    'HUC12_forest_and_shrubland_4': 2.727295802,
    'HUC10_grassland_and_pasture_3': 21.97415169,
    'HUC10_cropland_area_1': 7.781039427,
    'HUC12_developed_area_5': 30.82009239
}

coefficients = {
    'intercept': -0.171385241,
    'AVFST_Max': 0.010755746,
    'ARAIN_Average': 0.110557689,
    'HUC12_forest_and_shrubland_4': 0.333879373,
    'HUC10_grassland_and_pasture_3': -0.050150033,
    'HUC10_cropland_area_1': -0.023880666,
    'HUC12_developed_area_5': 0.483720003
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Minneola.")
