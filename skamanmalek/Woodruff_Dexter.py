...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Woodruff_Dexter</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)

# Initial values according to the baseline of 2022 for Lake Apopka
initial_values = {
    'Norm_CyAN': 3.22929532,
    'AVFST_Max': 85.658,
    'ARAIN_Average': 177.16,
    'HUC12_TN': 60.11220596,
    'HUC10_TP': 12.89646656,
...
coefficients = {
    'intercept': 0.128766679,
    'AVFST_Max': -0.046468592,
    'ARAIN_Average': 0.099345742,
    'HUC12_TN': 0.495433992,
    'HUC10_TP': -0.92159788,
    'HUC10_cropland_area_1': -0.104179403,
    'HUC12_developed_area_5': 0.734039051
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Woodruff_Dexter.")
