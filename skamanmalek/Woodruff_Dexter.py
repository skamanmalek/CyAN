...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Woodruff/Lake Dexter</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 6.654013814,
    'AVFST_Max': 85.658,
    'ARAIN_Average': 177.16,
    'HUC12_forest_and_shrubland_4': 34.21526164,
    'HUC10_grassland_and_pasture_3': 5.411480827,
    'HUC10_cropland_area_1': 0.339692516,
    'HUC12_developed_area_5': 9.689723914
}

coefficients = {
    'intercept': -0.235474676,
    'AVFST_Max': 0.056709351,
    'ARAIN_Average': 0.045513258,
    'HUC12_forest_and_shrubland_4': 0.279615833,
    'HUC10_grassland_and_pasture_3': 0.064025169,
    'HUC10_cropland_area_1': -0.095438534,
    'HUC12_developed_area_5': 0.933673492
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Woodruff/Lake Dexter.")
