...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Disston</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 3.382099507,
    'AVFST_Max': 86.324,
    'ARAIN_Average': 177.41,
    'HUC12_forest_and_shrubland_4': 43.3856348,
    'HUC10_grassland_and_pasture_3': 9.354178826,
    'HUC10_cropland_area_1': 1.784445048,
    'HUC12_developed_area_5': 1.170041221
}

coefficients = {
    'intercept': -0.060116015,
    'AVFST_Max': 0.013681045,
    'ARAIN_Average': -0.032331275,
    'HUC12_forest_and_shrubland_4': 0.144148225,
    'HUC10_grassland_and_pasture_3': -0.077165925,
    'HUC10_cropland_area_1': -0.009609326,
    'HUC12_developed_area_5': 0.677442514
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Disston.")
