...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Francis</h1>"
...
coefficients = {
    'intercept': -3.166671597,
    'AVFST_Max': 0.054459553,
    'ARAIN_Average': 0.444607899,
    'HUC12_forest_and_shrubland_4': 1.906728234,
    'HUC10_grassland_and_pasture_3': -0.933994957,
    'HUC10_cropland_area_1': 1.69788547,
    'HUC12_developed_area_5': 7.903126501
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Francis.")
