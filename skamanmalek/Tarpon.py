...
title_markdown = "<h1 style='color: blue; text-align: center;'>Future Cyanobacteria Bloom Magnitude Estimation in Lake Tarpon</h1>"
st.markdown(title_markdown, unsafe_allow_html=True)
# Data for Alligator Lake
initial_values = {
    'Norm_CyAN': 40.88463168,
    'AVFST_Max': 85.91,
    'ARAIN_Average': 177.71,
    'HUC12_forest_and_shrubland_4': 7.575467361,
    'HUC10_grassland_and_pasture_3': 5.427339775,
    'HUC10_cropland_area_1': 1.336490667,
    'HUC12_developed_area_5': 43.03516226
}

coefficients = {
    'intercept': 2.418908686,
    'AVFST_Max': -0.307520549,
    'ARAIN_Average': -0.635392156,
    'HUC12_forest_and_shrubland_4': -2.235510595,
    'HUC10_grassland_and_pasture_3': 0.009275537,
    'HUC10_cropland_area_1': -0.450691298,
    'HUC12_developed_area_5': -3.152472209
}
...
st.sidebar.write("The default values represent mean annual measurements derived from the 2022 baseline for Lake Tarpon.")
